...
class FriendMessagesTableViewCell: UITableViewCell {
    ...
    func initConstraints() {
        NSLayoutConstraint.activate([
            ...
            labelSender.leadingAnchor.constraint(equalTo: wrapperCellView.leadingAnchor, constant: 8),
            ...
            wrapperCellView.leadingAnchor.constraint(equalTo: leadingAnchor, constant: 4),
